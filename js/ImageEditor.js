;(function(window, document, fabric) {
    ...
    function Plugin(imageEditor, options) {
    ...
    function Toolbar(element) {
        ...
        this.actionsElement = element.querySelector('.imageEditor-toolbar-actions');
    }

    Toolbar.prototype.createButtonGroup = function(options) {
        var buttonGroup = document.createElement('li');
        buttonGroup.className = 'imageEditor-button-group';
    ...
    ButtonGroup.prototype.createButton = function(options) {
        ...
        button.className = 'imageEditor-button imageEditor-button-' + options.type;
        button.innerHTML = '<i class="imageEditor-icon-' + options.image + '"></i>';
    ...
    Button.prototype = {
        ...
        active: function(value) {
            if (value)
                this.element.classList.add('imageEditor-button-active');
            else
                this.element.classList.remove('imageEditor-button-active');
        },
        hide: function(value) {
            if (value)
                this.element.classList.add('imageEditor-button-hidden');
            else
                this.element.classList.remove('imageEditor-button-hidden');
        },
    ...
    ImageEditor.prototype = {
        ...
        initDOM: function(element) {
            ...
            toolbar.className = 'imageEditor-toolbar';
            toolbar.innerHTML = '<ul class="imageEditor-toolbar-actions"></ul>';

            // Create canvas element
            var canvas = document.createElement('canvas');
            var canvasContainer = document.createElement('div');
            canvasContainer.className = 'imageEditor-image-container';
            canvasContainer.appendChild(canvas);

            // Create container element
            this.container = document.createElement('div');
            this.container.className = 'imageEditor-container';
